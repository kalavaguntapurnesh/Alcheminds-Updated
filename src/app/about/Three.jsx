          ...
          <div className="w-full mx-auto px-4 max-w-7xl">
            <div className="justify-center w-full text-center pb-14">
              <div className="w-full max-w-3xl mx-auto space-y-4">
                ...
                <h3 className="text-4xl font-bold tracking-tight dark:text-white">
                  Get started with per-made Templates
                </h3>
                <div className="prose-lg text-gray-600 dark:text-white">
                  <p>
                    Use Templates to skip the configuration on the most
                    commonly-used in-app Experiences. Add them to your account
            ...
            <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 w-full md:grid-cols-3 ">
              <div className="flex items-start space-x-8">
                <div className="text-green-600 fill-green-500 w-14 h-14 shrink-0 border-2 border-red-500">
                  <svg
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="text-sm text-gray-700 dark:text-white dark:text-opacity-70">
                    <p>
                      Perfect for welcoming users or announcing big features
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="justify-center w-full text-center pt-14 ">
              <div className="w-full max-w-3xl mx-auto space-y-4">
               <button className="bg-companyColor text-white w-40 h-12 rounded-xl text-base inline-flex font-bold transition duration-150 ease-in-out focus:outline-none
