        ...
        <div className="w-full">
          <div className="w-full mx-auto px-4 max-w-7xl">
            ...
            <div className="justify-center w-full text-center pt-14 ">
              <div className="w-full max-w-3xl mx-auto space-y-4">
               <button className="bg-companyColor text-white w-40 h-12 rounded-lg text-base inline-flex font-bold transition duration-150 ease-in-out focus:outline-none
