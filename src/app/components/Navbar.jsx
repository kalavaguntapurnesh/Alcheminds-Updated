   ...
   items-center "
        >
          <div className="flex items-center ">
            <div>
              <h1 className="  text-3xl text-red-500 font-bold  lg:pl-0 pl-6 pt-4 cursor-pointer">
                EDU<span className="text-primaryColor">KARE.</span>
              </h1>
            </div>
            <ul className="hidden lg:flex pt-4  md:ml-12 gap-x-3">
              <div>
                <div className="flex">
                  <li
                    className="lg:p-3.2 p-[11px] cursor-pointer text-gray-500 font-medium hover:text-black"
                    onClick={homeDPChange}
                  >
                    <Link href="/">Home</Link>
                  </li>
                  <div
                      ...
                      <section class="col-span-4">
                        <div class="flex flex-col space-y-2">
                          ...
                          <div class="flex flex-col space-y-2">
                            <a
                              href="/tours"
                              class="py-2 w-full flex items-center px-3 rounded-lg transition duration-200 ease-in-out hover:no-underline group  hover:bg-purple-50 "
                              rel="noopener"
                            >
                              ...
                              <div class="space-y-1">
                                <div class="flex items-center space-x-2">
                                  <h4 class="text-gray-900 text-base flex items-center leading-5 font-bold mb-0">
                                    Tours
                                  </h4>
                                </div>
                                <div class="text-gray-500 font-normal text-sm">
                                  Drive product adoption with powerful tours
                                </div>
                              </div>
                            </a>
                            <a
                              href="/tooltips"
                              class="py-2 w-full flex items-center px-3 rounded-lg transition duration-200 ease-in-out hover:no-underline group   hover:bg-red-50 "
                              rel="noopener"
                            >
                            ...
                            <a
                              href="/surveys"
                              class="py-2 w-full flex items-center px-3 rounded-lg transition duration-200 ease-in-out hover:no-underline group   hover:bg-green-50 "
                              rel="noopener"
                            >
                            ...
                            <a
                              href="/launchers"
                              class="py-2 w-full flex items-center px-3 rounded-lg transition duration-200 ease-in-out hover:no-underline group  hover:bg-yellow-50 "
                              rel="noopener"
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  High customizable in-product widgets
                                </div>
                              </div>
                            </a>
                            <a
                              href="https://www.helpbar.ai"
                              class="py-2 w-full flex items-center px-3 rounded-lg transition duration-200 ease-in-out hover:no-underline group "
                              target="_blank"
                              rel="noopener"
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Free universal search built for SaaS
                                </div>
                              </div>
                            </a>
                          </div>
                        ...
                        <div class="flex flex-col space-y-2">
                          ...
                          <div class="flex flex-col space-y-1">
                            <a
                              ...
                              class="py-2 w-full flex items-center px-3 rounded-lg transition duration-200 ease-in-out hover:bg-gray-50 hover:no-underline"
                              rel="noopener"
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Create variations of in-app flows
                                </div>
                              </div>
                            </a>
                            <a
                            ...
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Create on-brand, beautiful Experiences
                                </div>
                              </div>
                            </a>
                            <a
                            ...
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Set the right pace for Experiences to appear
                                </div>
                              </div>
                            </a>
                            <a
                            ...
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Design Experiences quickly and consistently
                                </div>
                              </div>
                            </a>
                            <a
                            ...
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Get a heads-up if something changes
                                </div>
                              </div>
                            </a>
                            <a
                          ...
                          <div class="px-2">
                            <a
                              href="/features"
                              class="pt-6 text-gray-900 flex items-center mr-1 text-sm font-bold"
                              rel="noopener"
                            >
                          ...
                          <div class="flex flex-col space-y-2">
                            <div class="p-5 rounded-2xl bg-yellow-50">
                              <div class="flex flex-col space-y-6">
                                <a
                                  href="/whats-new/helpbar-actions-and-ai"
                                  class="flex items-center space-x-4 hover:no-underline"
                                  rel="noopener"
                                >
                                  ...
                                  <div>
                                    <div class="mb-1 text-base font-bold text-gray-900">
                                      HelpBar is ready to enable your users
                                    </div>
                                    <div class="text-sm font-medium text-gray-500">
                                      Add your integrations as Actions, enable
                                      AI Answers, and more
                                    </div>
                                  </div>
                                </a>
                                <a
                                  href="/whats-new/native-a-b-testing-for-tours"
                                  class="flex items-center space-x-4 hover:no-underline"
                                  rel="noopener"
                                >
                                  <div class="object-cover w-32 overflow-hidden rounded-lg shrink-0">
                                  ...
                                  <div>
                                    ...
                                    <div class="text-sm font-medium text-gray-500">
                                      Test different Announcement or Banner
                                      variants from your Dashboard
                                    </div>
                                  </div>
                                </a>
                                <a
                                  href="/whats-new/new-additional-actions"
                                  class="flex items-center space-x-4 hover:no-underline"
                                  rel="noopener"
                                >
                                  <div class="object-cover w-32 overflow-hidden rounded-lg shrink-0">
                                  ...
                                  <div>
                                    ...
                                    <div class="text-sm font-medium text-gray-500">
                                      Launch Arcade, Google Drive, Navattic, or
                                      any embeddable URL in-app
                                    </div>
                                  </div>
                                </a>
                              </div>
                      ...
                      <section class="col-span-6">
                        <div class="flex flex-col space-y-4">
                          ...
                          <div class="grid grid-cols-2 gap-2">
                            <a
                              href="/use-cases/better-user-onboarding"
                              class="py-2 w-full flex items-start px-3 rounded-lg transition duration-200 ease-in-out hover:bg-gray-50 hover:no-underline space-x-4"
                              rel="noopener"
                            >
                              <div class="w-10 h-10 shrink-0 rounded inline-flex items-center justify-center text-gray-600">
                                ...
                                >
                                  {" "}
                                  <path
                                    d="M5.24386 0.5C4.97864 0.5 4.72429 0.605357 4.53675 0.792893C4.34922 0.98043 4.24386 1.23478 4.24386 1.5C4.24386 1.76522 4.34922 2.01957 4.53675 2.20711C4.72429 2.39464 4.97864 2.5 5.24386 2.5H7.24386C7.50907 2.5 7.76343 2.39464 7.95096 2.20711C8.1385 2.01957 8.24386 1.76522 8.24386 1.5C8.24386 1.23478 8.1385 0.98043 7.95096 0.792893C7.76343 0.605357 7.50907 0.5 7.24386 0.5H5.24386Z"
                                    fill="#475569"
                                  ></path>{" "}
                                  <path
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Activate users quickly with hyper-targeted
                                  onboarding flows
                                </div>
                              </div>
                            </a>
                            <a
                              href="/use-cases/increase-feature-adoption"
                              class="py-2 w-full flex items-start px-3 rounded-lg transition duration-200 ease-in-out hover:bg-gray-50 hover:no-underline space-x-4"
                              rel="noopener"
                            >
                              <div class="w-10 h-10 shrink-0 rounded inline-flex items-center justify-center text-gray-600">
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Nudge users towards new, critical, or
                            ...
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Offer self-serve support with in-app guidance,
                                  so users find the answers they need
                                </div>
                              </div>
                            </a>
                            <a
                              href="/use-cases/get-product-feedback"
                              class="py-2 w-full flex items-start px-3 rounded-lg transition duration-200 ease-in-out hover:bg-gray-50 hover:no-underline space-x-4"
                              rel="noopener"
                            >
                              <div class="w-10 h-10 shrink-0 rounded inline-flex items-center justify-center text-gray-600">
                                ...
                                >
                                  {" "}
                                  <path
                                    d="M0.743862 2C0.743862 1.46957 0.954576 0.960859 1.32965 0.585786C1.70472 0.210714 2.21343 0 2.74386 0H9.74386C10.2743 0 10.783 0.210714 11.1581 0.585786C11.5331 0.960859 11.7439 1.46957 11.7439 2V6C11.7439 6.53043 11.5331 7.03914 11.1581 7.41421C10.783 7.78929 10.2743 8 9.74386 8H7.74386L4.74386 11V8H2.74386C2.21343 8 1.70472 7.78929 1.32965 7.41421C0.954576 7.03914 0.743862 6.53043 0.743862 6V2Z"
                                    fill="#475569"
                                  ></path>{" "}
                                  <path
                                    d="M13.7439 4V6C13.7439 7.06087 13.3224 8.07828 12.5723 8.82843C11.8221 9.57857 10.8047 10 9.74386 10H8.57186L6.80586 11.767C7.08586 11.916 7.40486 12 7.74386 12H9.74386L12.7439 15V12H14.7439C15.2743 12 15.783 11.7893 16.1581 11.4142C16.5331 11.0391 16.7439 10.5304 16.7439 10V6C16.7439 5.46957 16.5331 4.96086 16.1581 4.58579C15.783 4.21071 15.2743 4 14.7439 4H13.7439Z"
                                    fill="#475569"
                                  ></path>{" "}
                                </svg>
                              </div>
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Gather contextual feedback inside your app and
                      ...
                      <section class="col-span-6">
                        <div class="flex flex-col space-y-2">
                          <div class="flex gap-6 ">
                            <a
                              href="/recipes"
                              class=" flex-col  flex-1 hover:no-underline rounded-xl w-full flex  p-6  bg-green-50  "
                              rel="noopener"
                            >
                              ...
                              <div class="flex flex-col flex-1">
                                ...
                                <div class="flex-auto mb-4 text-sm font-medium text-gray-600">
                                  Leverage Chameleon with your existing stack
                            ...
                            <a
                              href="/inspiration"
                              class=" flex-col  flex-1 hover:no-underline rounded-xl w-full flex  p-6  bg-purple-50  "
                              rel="noopener"
                            >
                              {/* 	
			<img class=" h-32 mb-6  object-cover rounded-lg" src="/img/containers/assets/inspiration.png/5e91e19a6bb72fb594f8ed725e0e2a79.png" alt=""/> */}
                              ...
                              <div class="flex flex-col flex-1">
                                ...
                                <div class="flex-auto mb-4 text-sm font-medium text-gray-600">
                                  Smart ways to drive product adoption from
                                  leading SaaS orgs
                                </div>
                                <div class="flex flex-col justify-end flex-1">
                                  <div class="flex items-center space-x-2 text-sm font-bold text-gray-900">
                        ...
                        <div class="flex flex-col space-y-4">
                          ...
                          <div class="grid grid-cols-2 gap-2 space-y-2">
                            <a
                              ...
                              class="py-2 w-full flex items-center px-3 rounded-lg transition duration-200 ease-in-out hover:bg-gray-50 hover:no-underline space-x-6"
                              rel="noopener"
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Better target your users, stay updated with
                                  all user behavior, and enable users to quickly
                                  book a meeting with your team from inside your
                                  product
                                </div>
                              </div>
                            </a>
                            ...
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Use Salesforce contact and account attributes
                                  to target product tours
                                </div>
                              </div>
                            </a>
                            <a
                            ...
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Target your users with relevant in-product
                                  experiences, and deeply analyze the results
                                  with the rest of your product data
                                </div>
                              </div>
                            </a>
                            <a
                            ...
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Launch hyper-targeted in-product experiences
                                  and better analyze their performance alongside
                            ...
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Use Twilio Segment to install Chameleon in
                                  your product, and seamlessly send data between
                                  all of your tools
                                </div>
                              </div>
                            </a>
                            ...
                            >
                              ...
                              <div class="space-y-1">
                                ...
                                <div class="text-gray-500 font-normal text-sm">
                                  Rapidly send Chameleon data to your storage
                                  destinations to centralize with the rest of
                                  your product data
                                </div>
                              </div>
                            </a>
                      ...
                      <section class="col-span-5">
                        <div class="flex flex-col space-y-2">
                          ...
                          <div class="flex flex-col space-y-2">
                            <div class="flex flex-col space-y-4">
                              <a
                                href="/recipes/on-demand-onboarding"
                                class="flex flex-row items-center w-full p-4 space-x-4 rounded-lg hover:no-underline"
                                style={{ backgroundColor: "#6172F1" }}
                                rel="noopener"
                              >
                                ...
                                <div class="flex-1 text-lg font-semibold leading-tight tracking-tight text-white">
                                  Enable on-demand onboarding for seamless
                                  product adoption
                                </div>
                              </a>
                              <a
                                href="/recipes/rage-clicking"
                                class="flex flex-row items-center w-full p-4 space-x-4 rounded-lg hover:no-underline"
                                style={{ backgroundColor: "#F4913D" }}
                                rel="noopener"
                              >
                                <div class="flex space-x-2">
                                ...
                                <div class="flex-1 text-lg font-semibold leading-tight tracking-tight text-white">
                                  How to engage users who are rage-clicking
                                </div>
                              </a>
                              <a
                                href="/recipes/adopt-product-updates"
                                class="flex flex-row items-center w-full p-4 space-x-4 rounded-lg hover:no-underline"
                              ...
                              >
                                ...
                                <div class="flex-1 text-lg font-semibold leading-tight tracking-tight text-white">
                                  Get users to adopt any product updates with no
                                  friction
                                </div>
                              </a>
                            </div>
                    ...
                    <div class="grid px-4 grid-cols-12 gap-12 w-full mx-auto max-w-7xl overflow-hidden">
                        ...
                        <div class="flex flex-col space-y-2">
                          ...
                          <div class="flex flex-col space-y-2">
                            <div class="grid grid-cols-3 gap-6">
                              <a
                                href="/customers/mixpanel"
                                class="flex flex-col overflow-hidden transition duration-300 ease-in-out bg-white border border-gray-100 rounded-lg hover:shadow-lg hover:no-underline"
                                rel="noopener"
                              >
                                <div
                                  class="relative flex items-center justify-center h-32 py-6"
                                  style={{ backgroundColor: "#7061F6" }}
                                >
                                ...
                                <div class="flex flex-col flex-1 p-4 space-y-6">
                                  <div class="text-lg font-semibold leading-tight text-gray-900">
                                    How Mixpanel increases customer retention
                                    and satisfaction with Chameleon
                                  </div>
                                </div>
                              </a>
                              <a
                                href="/customers/fivetran"
                                class="flex flex-col overflow-hidden transition duration-300 ease-in-out bg-white border border-gray-100 rounded-lg hover:shadow-lg hover:no-underline"
                                rel="noopener"
                              >
                                <div
                                ...
                                <div class="flex flex-col flex-1 p-4 space-y-6">
                                  <div class="text-lg font-semibold leading-tight text-gray-900">
                                    How Fivetran used in-app messages to drive
                                    successful product updates
                                  </div>
                                </div>
                              </a>
                              <a
                                href="/customers/chili-piper"
                                class="flex flex-col overflow-hidden transition duration-300 ease-in-out bg-white border border-gray-100 rounded-lg hover:shadow-lg hover:no-underline"
                                rel="noopener"
                              >
                                <div
                                ...
                                <div class="flex flex-col flex-1 p-4 space-y-6">
                                  <div class="text-lg font-semibold leading-tight text-gray-900">
                                    How Chili Piper created a product-led sales
                                    motion that generated over $150K+ ARR from
                                    upsells in a few weeks
                                  </div>
                                </div>
                              </a>
                            </div>
                      ...
                      <section class="col-span-4">
                        <div class="flex flex-col space-y-2">
                          ...
                          <div
                            class="space-y-6 rounded-2xl border border-gray-100 p-6"
                          ...
                          >
                            ...
                            <div class="font-semibold text-gray-900 text-lg tracking-tight">
                              <p>
                                An easy-to-use product that has opened new doors
                                for our team
                              </p>
                            </div>
                            <div class="flex items-center space-x-4">
                              ...
                              <div>
                                <div class="font-semibold text-gray-900 leading-tight text-base">
                                  Gabrielle S
                                </div>
                                <div class="text-gray-600 text-sm tracking-tight">
                                  Director of Product
                                </div>{" "}
                              </div>
                            </div>
              ...
              <div className="flex ">
                <li className="lg:p-3.2 p-[11px] cursor-pointer text-gray-500 font-medium hover:text-black">
          ...
          <ul className="hidden lg:flex  pt-4">
            ...
            <li className="lg:p-3.2 p-[11px] cursor-pointer ">
              <a
                href=""
                className="border-red-500 border-2
        rounded-[4px] text-black px-8 py-2.5 "
              >
                Book Now{" "}
              </a>
            </li>
        ...
        rounded-[4px] text-white px-8 py-2.5 "
          ...
          <div
            className=" lg:hidden text-[32px] items-center flex pt-4 text-primaryColor"
            onClick={menuChange}
          >
            ...
            {!menu ? (
              <div className="absolute left-0 top-20 ">
                <ul className=" uppercase p-4 bg-gray-300 h-full">
                  <li className="p-4 border-b border-gray-600 text-[24px] text-white cursor-pointer">
                    <Link href="/">Home</Link>
                  </li>
                  <li className="p-4 border-b border-gray-600 text-[24px] text-white cursor-pointer">
                  ...
                  <li className="p-4 text-white cursor-pointer  border-b border-gray-600 text-[24px]">
                    <Link href="/contact">Contact</Link>
                  </li>
                  <li className=" p-4 cursor-pointer  font-medium text-[24px] text-white">
