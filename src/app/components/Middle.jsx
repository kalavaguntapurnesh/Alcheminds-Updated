...
const Middle = () => {
  return (
    <div className="bg-white">
      <div className=" mt-28 ml-24 mr-24 border-2 border-red-500 flex flex-row">
        ...
        <div className="w-2/5 border-2 border-green-500">
          <div className="border-2 border-pink-600 ">
            <p
              className="text-base 
                leading-6 font-medium tracking-wide uppercase
                text-companyColor
                "
            >
              Targeting
          ...
          <div className="mt-3 text-lg leading-7 text-gray-500">
            <p>
              ...
              <div class="flex">
                <div class="flex-shrink-0">
                  <div className="flex items-center justify-center h-12 w-12 rounded-full
                   bg-red-500 text-primaryColor
                                    ">
                    <svg class="w-6 h-6 fill-current" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><title>Icons 300</title><path d="M26.0206,52.021H44.0149a6.0056,6.0056,0,0,0,5.9981-6v-28a6.0056,6.0056,0,0,0-5.9981-6H26.0206a6.0056,6.0056,0,0,0-5.9984,6v6a1.9994,1.9994,0,1,0,3.9987,0v-6a2.0018,2.0018,0,0,1,2-2H44.0149a2.0016,2.0016,0,0,1,1.9994,2v28a2.0021,2.0021,0,0,1-1.9994,2H26.0206a2.0023,2.0023,0,0,1-2-2v-6a1.9994,1.9994,0,1,0-3.9987,0v6A6.0056,6.0056,0,0,0,26.0206,52.021Zm-18.0192-20a1.9994,1.9994,0,0,0,1.9987,2H29.9762V39.016a1.0266,1.0266,0,0,0,1.6214.819l9.9676-6.9888a.9957.9957,0,0,0,0-1.6381l-9.9676-6.9888a1.0267,1.0267,0,0,0-1.6214.8192v4.9824H10A1.9992,1.9992,0,0,0,8.0014,32.0209Z" fill-rule="evenodd"></path></svg>
                  </div>
                </div>
                <div class="ml-4">
                  <h5 class="text-lg font-medium leading-6 text-gray-800">On page triggers</h5>
                  <div class="mt-2 text-base leading-6 text-gray-500">
